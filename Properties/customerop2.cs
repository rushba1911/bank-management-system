...
namespace GUI.Properties
{
    public partial class customerop2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                bool check = CustomerDL.WithdrawMoney(accnum, amount);
                if (check)
                {
                    MessageBox.Show("Amount Withdrawed Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    customerinterface c = new customerinterface();
                    this.Close();
                    c.Show();
                }               
