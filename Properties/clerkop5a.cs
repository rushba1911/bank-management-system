...
{
    public partial class clerkop5a : Form
    {
        private string accnum;
        public clerkop5a(string accnum)
        {
            this.accnum = accnum;
            InitializeComponent();
        ...
        private void clerkop5a_Load(object sender, EventArgs e)
        {
            try
            {
                List<string> records = ClerkDL.SearchCustomerbyaccnum(accnum);
